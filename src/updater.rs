...
const REPO_NAME: &str = "uhtml-pics-parse";
...
impl Updater {
    pub fn new() -> Result<Self> {
        let client = Client::builder()
            .user_agent("uhtml-pics-parse_updater/1.0")
            .build()?;
        Ok(Self { client })
    }
    ...
    fn get_target_asset_name(&self) -> Result<String> {
        ...
        match (target, arch) {
            ("macos", "x86_64") => Ok("uhtml-pics-parse_macos_x86_64".to_string()),
            ("macos", "aarch64") => Ok("uhtml-pics-parse_macos_arm64".to_string()),
            ("linux", "x86_64") => Ok("uhtml-pics-parse_linux_x86_64".to_string()),
            ("linux", "aarch64") => Ok("uhtml-pics-parse_linux_arm64".to_string()),
            ("windows", "x86_64") => Ok("uhtml-pics-parse_windows_x86_64.exe".to_string()),
            ("windows", "aarch64") => Ok("uhtml-pics-parse_windows_arm64.exe".to_string()),
